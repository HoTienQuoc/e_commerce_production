...
class ProductModel extends ProductEntity {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      if (categoryId == null || categoryName == null) {
        throw FormatException('Missing or invalid category infomation');
      }
      final imageList = json['images'] as List? ?? [];
      final primaryImageUrl = json['primary_image_url'] as String?;
      final List<ProductImageModel> images = imageList
      ...
      return ProductModel(
        ...
        name: json['name'] as String? ?? 'Uname Product',
  ...
  // Helper methods for safer parsiong to reduce verbosity
