...
class ProductImagesSection extends StatefulWidget {
  ...
  const ProductImagesSection({super.key, required this.product});
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: const Icon(Icons.zoom_in, size: 20, color: Colors.white),
        ),
      ),
    );
  }
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(
                    AppTheme.borderRadiusSmall - 2,
                  ),
                  child: CachedNetworkImage(
                    imageUrl: _imageUrls[index],
                    fit: BoxFit.cover,
                    placeholder: (context, url) =>
                        _buildImagePlaceholder(size: 24),
                    errorWidget: (context, url, error) =>
                        _buildErrorImage(iconSize: 24),
                    memCacheWidth: 200,
                    memCacheHeight: 200,
                  ),
                ),
