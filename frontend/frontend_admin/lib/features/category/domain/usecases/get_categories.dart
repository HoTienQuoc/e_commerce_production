...
class GetCategoriesParams extends Equatable {
  ...
  const GetCategoriesParams({this.page = 1, this.pageSize = 20});
...
class GetCategories {
  ...
  Future<Either<Failure, PaginatedResponseEntity<CategoryEntity>>> call([
    GetCategoriesParams params = const GetCategoriesParams(),
  ]) async {
