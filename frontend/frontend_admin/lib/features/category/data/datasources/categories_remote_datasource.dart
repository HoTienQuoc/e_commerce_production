...
import 'package:frontend_admin/features/category/data/models/paginated_response_model.dart';
...
class CategoryRemoteDataSourceImpl implements CategoryRemoteDataSource {
  ...
  Future<CategoryModel> createCategory(
    ...
    try {
      ...
      if (image != null && image.containsKey('data')) {
        ...
        final String? mimeType = WebImageUtils.extractMimeTypeFromDataUrl(
          dataUrl,
        );
  ...
  Future<CategoryModel> updateCategory(
    ...
    try {
      ...
      if (parentId != null) {
        fields['parent'] = parentId.isEmpty ? null : parentId;
      }
      dynamic requestData;
      if (image != null && image.containsKey('data')) {
        final String dataUrl = image['data'];
