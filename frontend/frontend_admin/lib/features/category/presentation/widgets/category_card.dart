...
import 'package:frontend_admin/features/category/presentation/widgets/edit_category_dialog.dart';
...
class _CategoryCardState extends State<CategoryCard>
  ...
  Widget _buildCategoryIcon(bool isSmall) {
    ...
    return Container(
      ...
      child: Icon(_getCategoryIcon(), size: iconSize, color: Colors.white),
    );
  }
