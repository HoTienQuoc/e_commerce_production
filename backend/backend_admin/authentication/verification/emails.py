...
class EmailService:
    ...
    def send_password_reset_email(user):
        ...
        try:
            ...
            subject = f"{settings.APP_NAME} - Reset your password address"

            context = {'user': user, 'reset_password': reset_url, 'app_name': settings.APP_NAME}
            ...
            logging.error(f"Error sending password reset email preparation for {user.email}: {str(e)}")
            raise e
