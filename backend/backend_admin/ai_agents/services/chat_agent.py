...
class QueryIntent(Enum):
    """Enumeration of all supported query intents for chat classifictaion"""
    INVENTORY_STATUS = "inventory_status"
    SALES_DATA = 'sales_data'
    PRODUCT_PERFORMANCE = "product_performance"
    ORDER_STATUS = "order_status"
    CUSTOMER_INSIGHTS = "customer_insights"
    REVENUE_ANALYTIS = "revenue_analysis"
...
@dataclass
class ChatContext:
    """Context object that carried user and session information throughout the chat processing pipeline."""
    user_id: str
    session_id: str
...
class ChatResponse:
    ...
    def from_dict(cls, data: Dict[str, Any])->'ChatResponse':
        """Create ChatRepsonse from dictionary"""
        return cls(
            query = data['query'],
