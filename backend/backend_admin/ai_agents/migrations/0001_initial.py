...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('message_type', models.CharField(choices=[('user', 'User Message'), ('assitant', 'Assistant Response'), ('system', 'System Message'), ('error', 'Error Response')], db_index=True, default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(blank=True, choices=[('helpful', 'Response was helpful'), ('accurate', 'Information was accurate'), ('fast', 'Response was fast'), ('complete', 'Response was completed'), ('irrelevant', 'Response was irrelevant'), ('inaccurate', 'Information was inaccurate'), ('slow', 'Response was tool slow'), ('incomplete', 'Response was incomplete'), ('unclear', 'Response was unclear'), ('other', 'Other reason')], help_text='Reason for the feedback', max_length=50)),
