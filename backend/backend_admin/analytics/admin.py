...
from .models import (AnalyticsEvent, RevenueMetrics, AnalysticsSummary, UserSession, AnalysticsDashboard, UserBehavior)
...
@admin.register(AnalysticsSummary)
class AnalysticsSummaryAdmin(admin.ModelAdmin):
...
@admin.register(AnalysticsDashboard)
class AnalysticsDashboardAdmin(admin.ModelAdmin):
