# Generated by Django 6.0.6 on 2026-08-05 14:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['date'], name='analytics_a_date_7cf8b9_idx')],
            },
        ),
        migrations.CreateModel(
            name='RevenueMetrics',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('event_type', models.CharField(choices=[('view', 'Product View'), ('card_view', 'Add to Cart'), ('cart_remove', 'Remove from Cart'), ('purchase', 'Purchase'), ('search', 'Search'), ('wishilist_add', 'Add to Wishlist')], max_length=20)),
